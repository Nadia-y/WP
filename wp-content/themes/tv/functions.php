 ...
 */
add_action( 'wp_enqueue_scripts', 'tv_style' );
...
function tv_style() {
	...
	wp_enqueue_style( 'tv-style', get_stylesheet_uri() );
...
function tv_scripts() {
	...
	// wp_register_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js' );
	// wp_register_script( 'jquery', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js' );
	// wp_register_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js' );
	// wp_register_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js' );
